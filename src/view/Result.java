...
public class Result extends JPanel
{
    ...
    //okayResultText = new JLabel("Bra, men finns en del kvar att lära.");
        ...
        //ActionListeners
        ResultListener listener = new ResultListener(main, topLabel, goodResultText, okayResultText, badResultText, resultSummary, compareResult, easyResultWindow, mediumResultWindow, hardResultWindow,
                leftContainer, rightContainer, allLevelsIncludedLabel, menu, help, quit, correctAnswers, inPercent, comparedToEarlierResult, easyLevelResult, mediumLevelResult, hardLevelResult);
